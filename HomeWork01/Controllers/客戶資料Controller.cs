...
namespace HomeWork01.Controllers
{
    public class 客戶資料Controller : Controller
    {
        ...
        public ActionResult Details(int? id)
        {
            ...
            客戶資料 客戶資料 = m_customerInfo.searchById(id.Value);
            if (客戶資料 == null)
            {
                return HttpNotFound();
            }
        ...
        public ActionResult Create([Bind(Include = "Id, 客戶名稱, 統一編號, 電話, 傳真, 地址, Email")] 客戶資料 客戶資料)
        {
            ...
            {
                m_customerInfo.Add(客戶資料);
                m_customerInfo.UnitOfWork.Commit();
        ...
        public ActionResult Edit([Bind(Include = "Id,客戶名稱,統一編號,電話,傳真,地址,Email")] 客戶資料 客戶資料)
        {
            if (ModelState.IsValid)
            {
                var db = m_customerInfo.UnitOfWork.Context;
        ...
        {
            客戶資料 客戶資料 = m_customerInfo.searchById(id);
            m_customerInfo.Delete(客戶資料);
            m_customerInfo.UnitOfWork.Commit();
            return RedirectToAction("Index");
        }
    }
